<template>
  <div id="timeline">
  <div class="parafin ">
    <p class="side-text">This is the description of every week that shows how stem students spent each week with intensive learning and internship sessions in ethiopian airlines avation acadamy. MoreOver they have got an opportunity to have a guest speaker through different desplines. Beside this  they have got a soft skill and digital skills. </p>
...
.card{
  border-radius: 25px;
  background: #093145;
  box-shadow: 0 1px 2px 0 rgb(199, 185, 185), 0 10px 20px 0 rgb(243, 240, 240);
}
/* .myswiping{
  box-shadow: 0 1px 2px 0 rgba(134, 120, 120, 0.952), 0 10px 20px 0 rgb(159, 128, 128);
  background-image: url(../assets/images/photo_2023-08-23_15-00-21.jpg);
  background: fixed;
...
import { images } from 'ionicons/icons';
  ...
  export default {
    ...
    data(){
      return{
      count: 0,
        elemental: ["Abebe","Kebede","Alemu","Samuel"],
      }
    },
    setup() {
      return {
