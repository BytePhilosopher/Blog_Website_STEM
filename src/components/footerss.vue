      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-md-3 item">
            ...
            <ul>
              <li><a href="#">Robotics and coding</a></li>
              <li><a href="#">Internprnership</a></li>
          ...
          <div class="col-sm-6 col-md-3 item">
            <h3>About</h3>
            <ul>
              <li><a href="#">From all over Ethiopia</a></li>
              <li><a href="#">with in diversity</a></li>
              <li><a href="#">In one camp</a></li>
            </ul>
          </div>
          <div class="col-md-6 item text">
            <h3>Stem School</h3>
            <p>Unlock the door to creativity and innovation in the world of STEM - where you become the master of your journey.</p>
          </div>
        ...
        <p class="copyright">Ste School © 2023</p>
      </div>
    </footer>
  </div>
</template>
